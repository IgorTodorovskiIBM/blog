...
For a look at the patches applied to get LLaMa.cpp to work, visit [llamacppport](https://github.com/ZOSOpenTools/llamacppport). (Note, this was hacked in a weekend. :) I list the future consideration at the end of this blog).
